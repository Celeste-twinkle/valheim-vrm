# ValheimVRM 1.8.2 安装说明（Celeste-twinkle 分支）
...
3. 将 `ValheimVRM-1.8.2.zip` 直接解压到 `valheim.exe` 所在目录，合并
...
解压 `ValheimVRM-Server-1.8.2.zip`，并让各客户端安装相同模型文件，详见
...
- 查看 `BepInEx/LogOutput.log` 中的插件版本 **1.8.2**、模型导入错误和着色器错误。
