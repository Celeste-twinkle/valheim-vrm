...
public static class BuildAvatarRendering
{
    public static void Build()
    {
        ...
        var manifest = BuildPipeline.BuildAssetBundles("../Build", new[] {
            new AssetBundleBuild { assetBundleName = "avatar_rendering", assetNames = new[] { shaderPath } },
        ...
        if (manifest == null || ShaderUtil.ShaderHasError(shader)) throw new Exception("Rendering bundle build failed.");
