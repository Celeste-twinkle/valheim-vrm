...
{
    [BepInPlugin(AvatarSyncWire.ServerGuid, "ValheimVRM Server Sync", "2.0.2")]
    public sealed class ServerPlugin : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            Logger.LogInfo("Avatar sync server 2.0.2 ready; model, height, calibration and optional part visibility use authenticated peer and character ZDO IDs.");
        }
